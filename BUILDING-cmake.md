...
| `ENABLE_QUEST_VR_APP`    | `OFF`   | `OpenXR SDK`, Android NDK      | Builds the experimental Android NativeActivity host app for Meta Quest/OpenXR. This option is only valid when cross-compiling for Android.                                                                                                      |
